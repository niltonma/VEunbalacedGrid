...
dss.text("New monitor.powers1_V2G action=Save element=Load.634c  terminal=1 ppolar=no mode=1")
dss.text("New monitor.powers2 action=Save element=Load.634a  terminal=1 ppolar=no mode=1")
...
dss.text("New monitor.tensao action=Save element=Load.R60  terminal=1 ppolar=no mode=0") # mode=0 (monitoramento de tensões e corrente)
...
plt.plot(ls_f2_v2, lambda x: x + 0.25)
plt.show()
