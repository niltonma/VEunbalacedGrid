...
plt.plot(v_mag_pu.loc["rg60.1",:],color = "green", label = "RG60",  lw = 1.5)
plt.plot(v_mag_pu.loc["634.1",:],color = "Blue", label = "634.1",  lw = 1.5)
plt.plot(v_mag_pu.loc["634.2",:],color = "black", label = "634.2", ls = 'x', lw = 1.5)
plt.plot(v_mag_pu.loc["634.3",:],color = "purple", label = "634.3", ls = 'x', lw = 1.5)
plt.show()
