...
# for h in x_min:  #96 pontos
    ...
    v_mag[h+4]= dss.circuit.buses_vmag
    v_mag_pu[h+4] = dss.circuit.buses_vmag_pu
...
ax1.plot(x_inf, v_mag_pu.loc["rg60.1",4:],color = "green", label = "RG60",  lw = 1.5)
ax1.plot(x_inf,v_mag_pu.loc["634.1",4:],color = "Blue", label = "634.1",  lw = 1.5)
ax1.plot(x_inf,v_mag_pu.loc["634.2",4:],color = "black", label = "634.2", lw = 1.5)
ax1.plot(x_inf,v_mag_pu.loc["634.3",4:],color = "purple", label = "634.3",  lw = 1.5)
plt.legend()
