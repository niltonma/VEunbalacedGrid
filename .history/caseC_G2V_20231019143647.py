...
dss.text(f"New LoadShape.G2V_f2 npts={n_pontos_curva}  interval={0.25}  mult={ls_f2}")
...
dss.text("New Load.634b1 Bus1=634.2     Phases=1 Conn=Wye  Model=1 kV=0.277  kW=-168   kvar=0 daily=G2V_f2")
...
dss.text("plot Loadshape Object=G2V_f2")
dss.text("plot monitor object=powers2 labels=Yes")
dss.text("plot monitor object=powers1")
dss.text("export monitor object=powers1") #salva em uma pasta temp
...
ls_f2_v2 = functions.create_custom_ls('C:\\Users\\alves\\AppData\\Local\\OpenDSS\\IEEE13Nodeckt_Mon_powers1_1.csv',
                                      'C:\\Users\\alves\\Downloads\\IEEE13Nodeckt_Mon_powers1_1_v2.csv',ls_f2)
