...
df_p_kw.to_csv(r'C:\Users\alves\Documents\OpenDSS\replicar_artigos\df_p_kw.csv')
df_q_kvar.to_csv(r'C:\Users\alves\Documents\OpenDSS\replicar_artigos\df_p_kvar.csv')
