...
dss.text("New monitor.powers1 action=Save element=Transformer.XFM1  terminal=2 ppolar=yes mode=+64") # mode= 0 medir tensao
dss.text("New monitor.powers2 action=Save element=Line.632633  terminal=2 ppolar=yes mode=+64")
